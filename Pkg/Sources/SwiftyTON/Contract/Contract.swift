...
public struct Contract {
    ...
    public init(
        ...
        let state = try await tonlibWrapper.accountWithAddress(address.rawValue)
    ...
    public func execute(
        ...
        let localID = try await tonlibWrapper.accountLocalIDWithAccountAddress(address.rawValue)
        let result = try await tonlibWrapper.accountLocalID(localID, runGetMethodNamed: methodNamed, arguments: arguments)
    ...
    public func transactions(
        ...
        do {
            return try await tonlibWrapper.transactionsForAccountAddress(
                address.rawValue,
