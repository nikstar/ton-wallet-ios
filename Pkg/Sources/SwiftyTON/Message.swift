...
public final class Message {
    ...
    public init(
        ...
        let query = try await tonlibWrapper.prepareQueryWithDestinationAddress(
    ...
    deinit {
        ...
        Task {
            try? await tonlibWrapper.remove(
    ...
    public func fees() async throws -> Currency {
        ...
        let fees = try await tonlibWrapper.estimateFees(
            preparedQueryID: queryID
        )
