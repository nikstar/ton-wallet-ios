...
private extension Configuration.Network {
    ...
    var bundleFileURL: URL {
        guard let url = Foundation.Bundle.module.url(forResource: fileName, withExtension: "json", subdirectory: nil)
        else {
            fatalError(URLError(.badURL).localizedDescription)
        }
        return url
    ...
    var documentsFileURL: URL {
        ...
        let directoryURL = fileManager
            ...
            .appendingPathComponent("network_config/", isDirectory: true)
